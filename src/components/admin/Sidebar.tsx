    ...
    >
      ...
      <div className="p-4 border-b flex items-center gap-3"
        ...
        {!collapsed && (
          <div className="truncate">
            ...
            <p className="text-xs" style={{ color: '#6b7280' }}>Digital Catalog</p>
          </div>
        )}
        {onClose && (
          <button onClick={onClose} className="ms-auto text-gray-500 hover:text-white lg:hidden">
      ...
      <div className="p-3 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
        ...
        >
          ...
          {!collapsed && <span className="text-sm">معاينة الموقع</span>}
        </Link>
